              ...
              <table>
                <tbody>
                  {Object.entries(tokenData).map(([key, i]) => {
                    return (
                      <tr key={key}>
                        <td style={{ textAlign: "left", paddingRight: 25 }}>
                          {key}
                        </td>
      ...
      <table>
        <tbody>
          <tr>
            <td>AccessToken</td>
            <td>
              <textarea disabled value={accessToken} cols="80"></textarea>
            </td>
            <td>
          ...
          <tr>
            <td>IdToken</td>
            <td>
              <textarea disabled value={idToken} cols="80"></textarea>
            </td>
            <td>
              <button onClick={copyToClipboard(idToken)}>
                Copy To Clipboard
              </button>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <textarea
                disabled
                value={userInfoToken != null ? userInfoToken : "<fetching>"}
                cols="80"
              ></textarea>
            </td>
            <td>
              <button onClick={copyToClipboard(userInfoToken)}>
                Copy To Clipboard
              </button>
            </td>
          </tr>
